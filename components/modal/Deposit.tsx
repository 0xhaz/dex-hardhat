...
import {
  ...
  unselectedStyle,
  disableStyle,
} from "../../styles/deposit.styled";

const formInitialValues = { direction: null, amount: null };

const Deposit = ({ account }: { account: string }) => {
  const {
    state: { selectedMarket },
  } = useAppState();

  const { currentBalance, tokenBalance, deposit } = useExchangeData();
          ...
          <div>
            ...
            {currentBalance && (
              <WalletContainer>
                ...
                <div>
                  <Title>Available in Exchange</Title>
